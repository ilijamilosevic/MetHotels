...
export class RoomListComponent implements OnInit {
  ...
  constructor() {
    this.rooms = [
      ...
      new Room("Hotel Grand Spa", "This luxury hotel on Kopaonik will give you best place for recreation.", 549, "https://images.unsplash.com/photo-1582719508461-905c673771fd?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1025&q=80", 8.6)
    ]
  }
